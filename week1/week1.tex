...
git status 文件名\quad 用于查看单个文件的状态\par
git status 可查看当前文件夹所有文件的状态\par
...
git add 文件名 \quad 添加单个文件\par 
git add . 可将当前文件夹的所有文件添加到暂存区\par
也可使用通配符\\
\includegraphics[width=1\textwidth]{git add.png}
\subsubsection{将暂存区的文件提交到本地仓库}
git commit -m "提交的信息" \quad 将暂存区的文件提交到本地仓库
